...
#include "include/models/UnitCube.h"
...
void init(int argc, char** argv) {
    ...
    // vpr::ModelEntity* statueModel2 = new vpr::ModelEntity("statue","marble");
    statueModel->setSelectable(true);

    // vpr::ModelEntity* pedestalModel = new vpr::ModelEntity("pedestal", "marble");
    ...
    // waterLevelAnimation->addChild(waterSplash);
    ...
    for(int i = 0; i < 3; i++){
        ...
        // waterSplashModel->setPosition(i*offset,0.01,0.0);
    ...
    std::vector<std::tuple<glm::vec3,glm::vec3>> treePositions = {
        ...
        // std::make_tuple(glm::vec3(-1.386,baseY,1.47),glm::vec3(1.2,1.2,1.2)),
    ...
    // statueModel->setRotation(0.0,-3.14/2,0.0);
    // statueModel->setScale(0.008,0.008,0.008);
    ...
    // planeModel->setRotation(0.0,3.14,0.0);
    // bathhouse->addChild(planeModel);
    // root->addChild(terrainModel2);
    // root->addChild(pointLight);
    root->addChild(bathhouse);
    // root->addChild(planeModel);
    root->addChild(sunLight);
    // root->addChild(terrainModel);
    root->addChild(statueModel);
    // root->addChild(statueModel2);
    // root->addChild(pedestalModel);
    // root->addChild(bathhouseModel);
    scene->setRoot(root);
    ...
    // State.engine->registerAction(hovering);
